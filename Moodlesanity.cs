...
public class Moodlesanity : MonoBehaviour
{
    ...
    private static Dictionary<string, string> InternalMoodNameToCheck = new Dictionary<string, string>()
    {
        ...
        {"stroke3","Moodlesanity - Stroke"},
        {"cantbreathe3","Moodlesanity - Respiratory arrest"},
        {"thoraxdestroyed3","Moodlesanity - Lung failure"},
        {"pulmonaryembolism3","Moodlesanity - Pulmonary embolism"},
        {"oxygen0","Moodlesanity - Mild hypoxemia"},
        {"oxygen1","Moodlesanity - Hypoxemia"},
        {"oxygen2","Moodlesanity - Severe hypoxemia"},
        {"oxygen3","Moodlesanity - Critical hypoxemia"},
        {"arrythmia1","Moodlesanity - Arrhythmia"},
        {"arrythmia2","Moodlesanity - Ventricular tachycardia"},
        {"arrythmia3","Moodlesanity - Ventricular fibrillation"},
        {"palpitations3","Moodlesanity - Palpitations"},
        {"cardiacarrest3","Moodlesanity - Cardiac arrest"},
        {"hypoventilation0","Moodlesanity - Mild hypoventilation"},
        {"hypoventilation1","Moodlesanity - Hypoventilation"},
        {"hypotension0","Moodlesanity - Mild hypotension"},
        {"hypotension1","Moodlesanity - Hypotension"},
        {"hypotension2","Moodlesanity - Severe hypotension"},
        {"hypotension3","Moodlesanity - Circulatory collapse"},
        {"hypertension0","Moodlesanity - Mild hypertension"},
        {"hypertension1","Moodlesanity - Hypertension"},
        {"hypertension2","Moodlesanity - Severe hypertension"},
        {"hypertension3","Moodlesanity - Hypertensive crisis"},
        {"venom0","Moodlesanity - Mild toxicosis"},
        {"venom1","Moodlesanity - Toxicosis"},
        {"venom2","Moodlesanity - Severe toxicosis"},
        {"venom3","Moodlesanity - Toxic crisis"},
        ...
        {"smallbleeding0","Moodlesanity - Minor bleeding"},
        {"bleeding1","Moodlesanity - Bleeding"},
        {"heavybleeding2","Moodlesanity - Heavy bleeding"},
        {"maxbleeding3","Moodlesanity - Catastrophic bleeding"},
        {"internalBleed0","Moodlesanity - Internal bleeding"},
        {"internalBleed1","Moodlesanity - Internal bleeding"},
        {"internalBleed2","Moodlesanity - Internal bleeding"},
        {"internalBleed3","Moodlesanity - Internal bleeding"},
        {"internalBleed4","Moodlesanity - Internal bleeding"},
