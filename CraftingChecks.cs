...
public class CraftingChecks : MonoBehaviour
{
    ...
    public static Dictionary<string, string> CheckNameToItem = new Dictionary<string, string>()
    {
        ...
        {"Geiger counter Recipe", "geigercounter"},
        ...
        {"Tactical boots Recipe", "tacticalboots"},
        {"Tactical gloves Recipe", "tacticalgloves"},
        {"Duffel bag Recipe","duffelbag"},
        {"Material pouch Recipe","materialpouch"},
        {"Belt Recipe","belt"},
        {"Trauma rig Recipe", "traumarig"},
        ...
        {"Chest drain Recipe", "chestdrain"},
        {"Hand crank charger Recipe", "handcrank"},
    ...
    private static Dictionary<string, int> RecipeToINTRequirement = new Dictionary<string, int>()
    {
        ...
        {"Tactical boots Recipe",16},
        {"Tactical gloves Recipe",15},
        {"Duffel bag Recipe",11},
        {"Material pouch Recipe",10},
        {"Belt Recipe",10},
        {"Trauma rig Recipe",15},
        ...
        {"Chest drain Recipe",12},
        {"Hand crank charger Recipe",14},
    ...
    {   // Same order as items.py, and the internal recipe order in-game
        ...
        "Backpack Recipe",
        "Wood sandals Recipe",
        "Tactical boots Recipe",
        "Tactical gloves Recipe",
        "Duffel bag Recipe",
